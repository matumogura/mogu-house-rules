...
window.JIRAI_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { id: "brk_end", label: "区切り：終了時刻", options: ["めいっぱい・少し延長してもOK", "時間厳守で終わりたい"] },
      { id: "brk_mid", label: "区切り：中断", options: ["途中で区切ってもいい", "キリの良いところまで進めたい"] },
      { id: "rp_pace", label: "RPの進行", options: ["じっくり好きなだけやりたい", "長引いたらKPに進めてほしい"] },
      { id: "sched", label: "日程の押さえ方", options: ["多めに押さえて中で調整", "最低限＋足りなければ都度追加"] }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      { id: "dif_flags", label: "希望すること（複数可・その場の申告を優先）", options: ["生死のかかるダイスでCTを使いたい", "ファンブルのペナルティは軽い方がいい", "リアル時間を使うギミックは好みではない", "他PC・NPCの生死を左右したくない","CT制度は利用したくない"] }
    ]
  },
  {
  ...
  {
    id: "theme", title: "シナリオで扱う描写", type: "scale",
    items: [
  ...
  {
    id: "genre", title: "シナリオ種類・世界観", type: "scale",
    items: [
  ...
  {
    id: "hoproc", title: "秘匿HOの処理", type: "scale",
    items: [
